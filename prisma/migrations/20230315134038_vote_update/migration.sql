/*
  ...
  - The values [DONWVOTE] on the enum `vote_enum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "vote_enum_new" AS ENUM ('UPVOTE', 'DOWNVOTE');
